...
const STORAGE_MEMORY = 'thingsNearbyMemoryV25';
const STORAGE_LOCATION = 'thingsNearbyLocationV25';
...
out center tags;`;
    ...
    const endpoints = [
      { name: 'de', url: 'https://overpass-api.de/api/interpreter', timeout: 5000 },
